...
public class SocketServerActivity extends Activity {
	...
	static final String shortenerUrl = "http://211.189.19.55:8000/myapp/shortener";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(!CommandLine.isRootAccessAvailable())
		{
			Log.i("루팅","안됫당");
		}
	...
	private class socketServer implements Runnable {
		...
		public void run() {
			...
			try {
				...
				// TODO Auto-generated catch block
				Log.d("aaa", "2222222222222222222222222222222222");
				e.printStackTrace();
			}
	...
	private class sendScreen extends AsyncTask<Integer, Void, Integer> {
		...
		protected Integer doInBackground(Integer... params) {
			...
			// ��ġ�� ���� ȭ���� ����� ������
			if (dos != null) {
				sendTime = System.currentTimeMillis(); // ���� ���۽ð�
		...
		protected void onPostExecute(Integer retVal) {
			...
			if (vFrameTime > 100 && vFrameTime <= 1000) { // ���� ���� �̳��� ���
